...
dateState.startTimeStamp = Date.now() - (getRandomIntegerBetween(1, 60) * getRandomIntegerBetween(1, 60) * getRandomIntegerBetween(1, 24) * getRandomIntegerBetween(1, 31) * 1000);
